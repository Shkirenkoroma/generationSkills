        ...
        <S.MiddlePart>
          ...
          <S.GenerationGroup>
            <S.BowlGroup>
              ...
              <S.Center src={center} rotate={rotate} alt="place for center position" />
              <S.OpacityCycle src={opacitycycle} alt="place for opacity shame" />
              <S.Arrow src={arrow} rotate={rotate} alt="place for arrow of generation" />
            </S.BowlGroup>
            <S.LevelGroup>
